...
?>
  ...
  <button id="showMe" onclick="getLocation()" class="btn center-align">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-beta/js/materialize.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBciOgLbb--gYktG0GwHaVWkw6OKRspOd0"></script>
...
<script type="text/javascript">
 ...
 const __KEY = "AIzaSyBciOgLbb--gYktG0GwHaVWkw6OKRspOd0";
