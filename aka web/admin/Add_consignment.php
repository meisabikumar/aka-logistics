			...
			<div class="tab-pane active" id="horizontal-form">
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">User Shipper Name:</label>
							<div class="col-sm-8">
					<input type="text" class="form-control1" name="shippername" placeholder="Shipper Name" required="" id="dearname">
							...
							<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">User Shipper address :</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">User Phone:</label>
							<div class="col-sm-8">
							...
							<div class="col-sm-8">
							 <select class="form-control" id="sel1" name="material_descrition">
   									 ...
   									 <option value="Raw materilas">Raw materilas</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="dateofbooking" placeholder="Enter name" required="" type="Date" id="dearname">
							</div>
						</div>
						<div class="form-group">
