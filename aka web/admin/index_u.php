...
div.container {
        ...
        <div class="graphs">
          <div class="sign-in-form">
            ...
            <div class="sign-in-form-top">
              <p><span>Sign In to</span> <a href="#">User Panel</a></p>
            </div>
            <div class="signin">
                ...
                <div class="log-input">
                 <div class="log-input-left">
                  ...
                  <option value="admin" disabled="">Admin</option>
                    ...
                    <option value="corporate" selected="">User Corporate</option>
                  </select>
                  </div>
                  <!-- <span class="checkbox2">
                    <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i></label>
  ...
  if($ros)
  {
    ...
    echo"<script>alert('login error');window.location='index_u.php';</script>";
  }
