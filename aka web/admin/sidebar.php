  ...
  <section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
          ...
          <li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>DealerShip Request</span></a>
            <ul class="sub-menu-list">
              <!--<li><a href="add_dealerrequest.php">Add Request</a> </li>-->
              <li><a href="view_dealerrequest.php">View Dealership Request</a></li>
            </ul>
          </li>
          ...
          <li class="menu-list">
            ...
            <span>Branch</span></a>
            <ul class="sub-menu-list">
              <li><a href="add_branchrequest.php">Add Dealership branch</a> </li>
              <li><a href="branch_details.php">edit details branch</a> </li>
            </ul>
          </li>
      ...
      <!-- <li><a href="consignment_report.php"><i class="lnr lnr-cog"></i><span>Consignment Report</span></a></li>-->
                  ...
                  <li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>Dispatches details</span></a>
            <ul class="sub-menu-list">
          ...
          <li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>Request Location</span></a>
            <ul class="sub-menu-list">
            <li><a href="location.html">Request Location</a> </li>
            </ul>
          </li>
      ...
      <!-----------------------------------------dealer start------------------------------------>
         ...
         if($_SESSION['user']=='dealer')
        {
          ...
          <li class="menu-list">
            <a href="#"><i class="lnr lnr-cog"></i>
              <span>Dealership</span></a>
            <ul class="sub-menu-list">
            <li><a href="add_dealerrequest.php">Add Dealership Request</a> </li>
            </ul>
          </li>
          ...
          <li class="menu-list">
            ...
            <ul class="sub-menu-list">
            <li><a href="branch_details.php">edit details branch</a> </li>
            <li><a href="view_branchrequest.php">View branch request</a></li>
        ...
        ?>
          ...
          <!-- <li><a href=" admin/about"><i class="lnr lnr-book"></i> 
